...
package com.rythim.music.listentogether
...
import com.rythim.music.constants.ListenTogetherAutoApprovalKey
import com.rythim.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.rythim.music.constants.ListenTogetherIsHostKey
import com.rythim.music.constants.ListenTogetherRoomCodeKey
import com.rythim.music.constants.ListenTogetherServerUrlKey
import com.rythim.music.constants.ListenTogetherSessionTimestampKey
import com.rythim.music.constants.ListenTogetherSessionTokenKey
import com.rythim.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.rythim.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.rythim.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.rythim.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.rythim.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.rythim.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.rythim.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
