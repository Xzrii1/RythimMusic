...
import com.rythim.music.constants.AndroidAutoSectionsOrderKey
import com.rythim.music.constants.AndroidAutoYouTubePlaylistsKey
import com.rythim.music.ui.screens.settings.AndroidAutoSection
import com.rythim.music.ui.screens.settings.deserializeSections
import com.rythim.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.rythim.innertube.pages.HomePage.Section>()
