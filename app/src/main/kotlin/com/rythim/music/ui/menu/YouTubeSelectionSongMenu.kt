            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.rythim.music.db.entities.Song(
                            song =
                                com.rythim.music.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.rythim.music.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.rythim.music.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
