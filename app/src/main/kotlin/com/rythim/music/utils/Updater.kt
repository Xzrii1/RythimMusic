...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Yamzzdev/Rythim-Music"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Rythim.apk" -> "universal" to "foss"
                name == "Rythim-with-Google-Cast.apk" -> "universal" to "gms"
